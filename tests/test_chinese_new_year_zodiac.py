...
class TestChineseNewYearZodiacChinese:
    ...
    def test_zodiac(self):
        ...
        assert self.cny_zodiac_obj.zodiac(2023) == '兔'
        assert self.cny_zodiac_obj.zodiac(2022) == '虎'
        assert self.cny_zodiac_obj.zodiac(2021) == '牛'
        assert self.cny_zodiac_obj.zodiac(2020) == '鼠'
        assert self.cny_zodiac_obj.zodiac(2019) == '猪'
        assert self.cny_zodiac_obj.zodiac(2018) == '狗'
        assert self.cny_zodiac_obj.zodiac(2017) == '鸡'
        assert self.cny_zodiac_obj.zodiac(2016) == '猴'
        assert self.cny_zodiac_obj.zodiac(2015) == '羊'
        assert self.cny_zodiac_obj.zodiac(2014) == '马'
        assert self.cny_zodiac_obj.zodiac(2013) == '蛇'
        assert self.cny_zodiac_obj.zodiac(2012) == '龙'
        assert self.cny_zodiac_obj.zodiac(2011) == '兔'
        assert self.cny_zodiac_obj.zodiac(2010) == '虎'
        assert self.cny_zodiac_obj.zodiac(2009) == '牛'
        assert self.cny_zodiac_obj.zodiac(2008) == '鼠'
        assert self.cny_zodiac_obj.zodiac(2007) == '猪'
        assert self.cny_zodiac_obj.zodiac(2006) == '狗'
        assert self.cny_zodiac_obj.zodiac(2005) == '鸡'
        assert self.cny_zodiac_obj.zodiac(2004) == '猴'
        assert self.cny_zodiac_obj.zodiac(2003) == '羊'
        assert self.cny_zodiac_obj.zodiac(2002) == '马'
        assert self.cny_zodiac_obj.zodiac(2001) == '蛇'
        assert self.cny_zodiac_obj.zodiac(2000) == '龙'
        assert self.cny_zodiac_obj.zodiac(1999) == '兔'
        assert self.cny_zodiac_obj.zodiac(1998) == '虎'
        assert self.cny_zodiac_obj.zodiac(1997) == '牛'
        assert self.cny_zodiac_obj.zodiac(1996) == '鼠'
        assert self.cny_zodiac_obj.zodiac(1995) == '猪'
        assert self.cny_zodiac_obj.zodiac(1994) == '狗'
        assert self.cny_zodiac_obj.zodiac(1993) == '鸡'
        assert self.cny_zodiac_obj.zodiac(1992) == '猴'
        assert self.cny_zodiac_obj.zodiac(1991) == '羊'
        assert self.cny_zodiac_obj.zodiac(1990) == '马'
        assert self.cny_zodiac_obj.zodiac(1989) == '蛇'
        assert self.cny_zodiac_obj.zodiac(1988) == '龙'
        assert self.cny_zodiac_obj.zodiac(1987) == '兔'
        assert self.cny_zodiac_obj.zodiac(1986) == '虎'
        assert self.cny_zodiac_obj.zodiac(1985) == '牛'
        assert self.cny_zodiac_obj.zodiac(1984) == '鼠'
        assert self.cny_zodiac_obj.zodiac(1983) == '猪'
        assert self.cny_zodiac_obj.zodiac(1982) == '狗'
        assert self.cny_zodiac_obj.zodiac(1981) == '鸡'
        assert self.cny_zodiac_obj.zodiac(1980) == '猴'
        assert self.cny_zodiac_obj.zodiac(1979) == '羊'
        assert self.cny_zodiac_obj.zodiac(1978) == '马'
        assert self.cny_zodiac_obj.zodiac(1977) == '蛇'
        assert self.cny_zodiac_obj.zodiac(1976) == '龙'
        assert self.cny_zodiac_obj.zodiac(1975) == '兔'
